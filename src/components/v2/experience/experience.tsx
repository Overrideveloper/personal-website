    ...
    componentWillLoad() {
        this.jobsWorked = [
            ...
            },
            {
                ...
                role: 'Software Engineer',
                type: 'Freelance',
                location: { state: 'Moscow', country: 'Russia' },
                        ...
                        this.jobsWorked.map(job => {
                            return (
                                <div class="v2-experience-card">
                                    ...
                                    <div class="job-flex">
                                        <h5 class="job-role">{job.role}</h5>
                                        <span class="job-type">{job.type}</span>
                                    </div>
                                    <div class="job-flex">
                                        <h6 class="job-location">{job.location.state} :: {job.location.country}</h6>
                                        <h6 class="job-duration">{job.duration}</h6>
                                    </div>
                                    {
                                        job.domains.map(domain => {
                                            return ( <span class="job-domain">{domain}</span> );
                                        })
                                    }
                                </div>
                            );
